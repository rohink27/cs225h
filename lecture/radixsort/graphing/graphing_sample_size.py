...
import pandas as pd
standard_file = pd.read_csv('../data/standard_size.csv')
print(standard_file[' Sample Size'])
x_axis = standard_file[' Sample Size']
y_axis = standard_file[' Time']

radix_file = pd.read_csv('../data/optimised_decimal_size.csv')
x_axis2 = radix_file[' Sample Size']
